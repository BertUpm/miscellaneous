...
private:
    ...
    filt_floating_avg<MIN_DATA_SAMPLES_FOR_CALIB> *m_acc_x_filt;    
    filt_floating_avg<MIN_DATA_SAMPLES_FOR_CALIB> *m_acc_y_filt;    
    filt_floating_avg<MIN_DATA_SAMPLES_FOR_CALIB> *m_acc_z_filt;    
    
    filt_floating_avg<MIN_DATA_SAMPLES_FOR_CALIB> *m_mag_x_filt;    
    filt_floating_avg<MIN_DATA_SAMPLES_FOR_CALIB> *m_mag_y_filt;    
    filt_floating_avg<MIN_DATA_SAMPLES_FOR_CALIB> *m_mag_z_filt;
};
